    ...
    def __init__(self):
       ...
       #learning_rate=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-07, amsgrad=False, name='Adam'
        ...
        self.architecture = [
              ...
              #       activation="relu", name="block1_conv1"),
              # Conv2D(64, 3, 1, padding="same",
              #       activation="relu", name="block1conv2"),
              # MaxPool2D(2, name="block1_pool"),
       ...
       #      # Block 3.1
       #      Conv2D(256, 3, 1, padding="same",
       #             activation="relu", name="block3.1_conv1"),
       #      Conv2D(256, 3, 1, padding="same",
       #             activation="relu", name="block3.1_conv2"),
       #      Conv2D(256, 3, 1, padding="same",
       #             activation="relu", name="block3.1_conv3"),
       #      MaxPool2D(2, name="block3.1_pool"),
       #      # Block 4
       #      Conv2D(512, 3, 1, padding="same",
       #             activation="relu", name="block4_conv1"),
       #      Conv2D(512, 3, 1, padding="same",
